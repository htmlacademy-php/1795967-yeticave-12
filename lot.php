...
//print_r($_GET);
// Получить элемент с ключом id из _GET
// Написать функцию которая выгрузить из бд информацию о лоте по его идентификатору
// Собрать шаблон из html файла для страницы лота и передать туда данные
/** @var mysqli $link
                ...
                <div class="lot-item__content">
                    ...
                    <div class="lot-item__right">
                        <div class="lot-item__state">
                            <?php
                            $timeLeft = timeLeft($item['finish_date'], $currentDate); ?>
                            <div
                                class="lot-item__timer timer <?php if ((int)$timeLeft[0] < 1): ?>  timer--finishing <?php endif; ?> ">
                                <?= implode(':', timeLeft($item['finish_date'], $currentDate)) ?>
                            </div>
